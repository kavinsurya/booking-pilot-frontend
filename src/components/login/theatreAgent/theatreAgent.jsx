...
const TheatreLogin = () => {
  ...
  const loginFunction = async (event) => {
    ...
    let url = 'http://localhost:5000/agent/login'
    ...
    if (Fetchdata.status === 200) {
      ...
      localStorage.setItem("id", Fetchdata._id);
      debugger
      history.replace('/HomepageAgent');
    }
        ...
        <div className="login-box">
          ...
          <form onSubmit={loginFunction} method="POST">
            ...
            <div className="user-box">
              ...
              <p className="sign-up">
                Don't have an account? <a className="anchor-sign-up" href="/Register/agent">Create One</a>
              </p>
            </div>
            <button href="">
              <span></span>
